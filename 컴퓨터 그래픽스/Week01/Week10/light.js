...
function setLighting(program){
    ...
    var matAmbient = [1.0, 0.0, 0.0, 1.0]; // 안 받건 받건 반사 어두ㅜㄴ 부분이 빨강
    var matDiffuse = [0.0, 1.0, 1.0, 1.0]; // 나는 파랑
    var matSpecular = [1.0, 0.0, 1.0, 1.0]; // 
    var matShininess = 100.0; // 100은 꼬갈이 좁아짐 20보다 지수승 spotlight 영역
    ...
    gl.uniform1f(spotExpLoc, 100.0); // 크게하면 영역 좁아짐
